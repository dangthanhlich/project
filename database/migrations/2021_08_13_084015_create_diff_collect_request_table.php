...
class CreateDiffCollectRequestTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('diff_collect_request', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('diff_collect_request');
    }
}
