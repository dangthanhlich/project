...
class CreateReferencesTempCaseTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('temp_case', function (Blueprint $table) {
            $table->foreign('scrapper_office_code')->references('office_code')->on('mst_scrapper');
    ...
    {
        Schema::table('temp_case', function (Blueprint $table) {
            $table->dropForeign(['scrapper_office_code']);
