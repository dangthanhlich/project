...
class Cas012Request extends FormRequest
{
    /**
    ...
    public function messages() {
        return [
            'collect_plan_date.required' => ConfigUtil::getMessage('c-001', ['予定日']),
            'collect_plan_date.date_format' => ConfigUtil::getMessage('c-010', ['予定日']),
        ];
    }
}
