...
<div class="row">
    <div class="col-12">
        <div class="card card-user">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('case.handleCas011') }}" id="cas011-form" class="form-add-edit">
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
                            <x-forms.text
                        ...
                        <div class="col-md-4">
                            <x-forms.date
                                name="collect_receive_plan_date"
                                isRequired="true"
                                label="予定日"
                                :value="old('collect_receive_plan_date') !== null ? old('collect_receive_plan_date') : ''"
                            />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <x-forms.text
                                ...
                                label="メモ"
                                :value="old('collect_plan_memo') !== null ? old('collect_plan_memo') : ''"
                            />
                        </div>
                        ...
                        <div class="col-md-4">
                            <x-forms.checkbox
                                ...
                                :valueChecked="old('plan_date_adjusted_flg') ? old('plan_date_adjusted_flg') : []"
                            />
                        </div>
                    </div>
...
@push('scripts')
    <script src="{{ mix('js/screens/cas/cas01/cas011.js') }}"></script>
@endpush
