                ...
                <div class="card card-user">
                    ...
                    <div class="card-body pl-2 pr-2">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="check">
                                    ...
                                    <label>
                                        <input type="radio" class="minimal-blue is-mismatch" name="r1" id="radio2" value="2" {{ $mismatchs->count() === 0 ? 'checked' : '' }} /><span>なし</span>
                                    </label>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <a href="{{ route('case.cas-072', ['caseNo' => $case->case_no]) }}">
                                <button type="button" class="btn btn-info btn-round btn-long">保存</button>
                            </a>
                            <br>
